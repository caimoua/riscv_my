...
module rv32i_cached_system_ahb_top_tb;
  ...
  initial begin
    ...
    rom[2] = 32'h0021_01b3; // add  x3, x2, x2
    rom[3] = 32'h0aa0_0213; // addi x4, x0, 0xAA
    rom[4] = 32'h0040_a423; // sw   x4, 8(x1)
    rom[5] = 32'h0080_a283; // lw   x5, 8(x1)
    rom[6] = 32'h0051_8333; // add  x6, x3, x5
