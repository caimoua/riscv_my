...
module rv32i_pipe_dynamic_branch_predict_tb;
  ...
  initial begin
    ...
    // Dynamic predictor program.
    // The forward BEQ at 0x10 is repeatedly taken. Static prediction misses it
    // every time; the BHT+BTB path should miss once, learn the target, then hit.
    ...
    imem[8]  = 32'hfe20_98e3; // 0x20: bne  x1, x2, -16
    imem[9]  = 32'h0550_0293; // 0x24: addi x5, x0, 0x55
    imem[10] = 32'h0010_0073; // 0x28: ebreak
  end
